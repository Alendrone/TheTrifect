...
function ux () {
 ...
 ico.addEventListener("click",function(){
  ...
  if (menu.val === 2) {
    van.add(base,div({class:"text-danger"},"No episodes yet"),div({class:"yt",id:"ytplay"}));
    var after = base.getElementsByClassName("yt")[0];
    after.dataset["youtubeId"] = "_KDUICa4UCM";
    console.log(after)
    var video = new Vlitejs(after,{options:{
    controls: true,
    autoplay: true,
    playPause: true,
    progressBar: true,
    ...
    volume: true,
    fullscreen: true,
    poster:"https://i3.ytimg.com/vi/" + after.dataset["youtubeId"] + "/maxresdefault.jpg",
    bigPlay: true,
    playsinline: true,
    loop: true,
    muted: false,
