...
function ux() {
  ...
  if (menu.val === 2) {
    ...
    if (subcqint) {
      van.add(base,iframe({src:"https://www.youtube-nocookie.com/embed/" + ytb.dataset["youtubeId"] + "?autoplay=1&cc_load_policy=3&controls=0&disablekb=1&end=60&loop=1&modestbranding=1&playsinline=1&rel=0",frameborder:"0",allow:"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"}));
      return base;
    }
